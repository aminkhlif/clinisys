  ...
  return (
    <Dialog open={ouvert} onClose={onFermer} fullScreen>
      <Box sx={{ position: 'relative', height: '100vh', bgcolor: '#0A0A0A', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        ...
        <IconButton
          onClick={onFermer}
          sx={{ position: 'absolute', top: 40, right: 28, zIndex: 2, color: '#FFFFFF', '&:hover': { bgcolor: 'rgba(255,255,255,0.1)' } }}
        >
          <CloseIcon />
        </IconButton>
        ...
        <IconButton
          onClick={precedent}
          sx={{ position: 'absolute', left: 24, zIndex: 2, color: 'rgba(255,255,255,0.6)', '&:hover': { color: '#FFFFFF', bgcolor: 'rgba(255,255,255,0.1)' } }}
        >
          <ChevronLeftIcon fontSize="large" />
        </IconButton>
        <IconButton
          onClick={suivant}
          sx={{ position: 'absolute', right: 24, zIndex: 2, color: 'rgba(255,255,255,0.6)', '&:hover': { color: '#FFFFFF', bgcolor: 'rgba(255,255,255,0.1)' } }}
        >
